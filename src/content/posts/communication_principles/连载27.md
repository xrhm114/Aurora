...
$$\qquad$$该单音信号的波长为:
![27-1.png](https://cdn.jsdelivr.net/gh/xrhm114/pic/images/20251126154635706.png)
...
![27-2.png](https://cdn.jsdelivr.net/gh/xrhm114/pic/images/20251126154635707.png)
$$\qquad$$同时, 通过调制把不同的信号频㦈搬移到不同的频率范围内, 也就实现了频分多路复用(FDM)。
![27-3.png](https://cdn.jsdelivr.net/gh/xrhm114/pic/images/20251126154939366.png)