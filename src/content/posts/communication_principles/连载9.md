...
![](https://i.stardots.io/aurorean1/1748423282494.jpg "9-1.jpg")

再叠加一个cos(3x)余弦分量：y=0.5+0.637.\*cos(x)-0.212.\*cos(3\*x);

![](https://i.stardots.io/aurorean1/1748423384058.jpg "9-2.jpg")

再叠加一个cos(5x)余弦分量：y=0.5+0.637.\*cos(x)-0.212.\*cos(3\*x)+0.127.\*cos(5\*x);

![](https://i.stardots.io/aurorean1/1748423457039.jpg "9-3.jpg")
